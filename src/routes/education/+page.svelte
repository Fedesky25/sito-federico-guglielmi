...
<svelte:window bind:scrollY={scrollY} bind:innerHeight={height} />

<ScreenMask id="pixelator" size_hint={64} extend={6} progress={1 - progress + Math.floor(progress)} />
...
<div class="wrapper">
    ...
    <section
        ...
        <div>
            ...
            <ul>
                ...
                <li><time datetime="2023-10">October 2023</time> &mdash; present</li>
    ...
    class={["bpad", progress < 2 ? null : progress < 3 ? "masked" : "hidden"]}>
        <div>
            ...
            <ul>
                <li>Politecnico di Torino, Italy</li>
                <li><time datetime="2020-9">September 2020</time> &mdash; <time datetime="2023-9">Semptember 2023</time></li>
    ...
    <section class="bpad">
        <div>
            ...
            <ul>
                ...
                <li><time datetime="2015-9">September 2015</time> &mdash; <time datetime="2020-7">July 2020</time></li>
